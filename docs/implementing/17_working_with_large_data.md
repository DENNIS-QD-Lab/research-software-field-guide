...
The data rule (`../../CLAUDE.md`, `../onboarding/04_environments.md`) is simple: **data lives outside
...
raises the question `16_running_a_dry_lab_experiment.md` depends on: if the inputs are not in git,
...
(`16_running_a_dry_lab_experiment.md`), a **content hash** alongside the dataset name:
...
`21_versioning_and_releases.md`) **plus a referenced, checksummed dataset**. Freeze the code, name
