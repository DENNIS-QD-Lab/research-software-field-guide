...
The committed `.ipynb` has no outputs and minimal metadata. Your local working copy keeps everything, so your screen does not change. Setup is a pre-commit hook, covered in `docs/onboarding/07_notebooks.md`.
